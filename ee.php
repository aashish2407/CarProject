...
<div class="row" >
    <div class="col-4 bg-success mt-4 black">
    ...
    <div class="col-4 bg-warning"id="b1">
      <div >
        <br>
        <br>
        <br>
    ...
    <div class="col-4 bg-success" text="aligncenter" id="a1">
      <br>
      <br>
      <br>
      <br>
...
<div id="c1" class="bg-secondary">

<i style="font-size:24px" class="fa">&#xf1f9;</i> <span class="color-warning">2016-2024 Service Used Technology Private Limited(PVT)</span>
</div>
</form>
